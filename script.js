  ...
  categories: [
    {
      ...
      products: [
        ...
        { name: { en: "Anise", ar: "يانسون", ru: "Анис", de: "Anis", it: "Anice" }, desc: { en: "Hot anise drink", ar: "مشروب يانسون ساخن", ru: "Горячий напиток с анисом", de: "Heißes Anisgetränk", it: "Bevanda calda all'anice" }, price: 25, image: "images/products/anise.webp" },
        ...
        { name: { en: "Green Tea", ar: "شاي أخضر", ru: "Зеленый чай", de: "Grüner Tee", it: "Tè Verde" }, desc: { en: "Green tea", ar: "شاي أخضر", ru: "Зеленый чай", de: "Grüner Tee", it: "Tè verde" }, price: 25, image: "images/products/green-tea.webp" },
        { name: { en: "Hibiscus", ar: "كركديه", ru: "Каркаде", de: "Hibiskus", it: "Ibisco" }, desc: { en: "Hibiscus tea", ar: "شاي الكركديه", ru: "Чай из гибискуса", de: "Hibiskustee", it: "Tè all'ibisco" }, price: 25, image: "images/products/hibiscus.webp" },
        { name: { en: "Mint", ar: "نعناع", ru: "Мята", de: "Minze", it: "Menta" }, desc: { en: "Hot mint tea", ar: "شاي نعناع ساخن", ru: "Горячий мятный чай", de: "Heiße Minztee", it: "Tè alla menta caldo" }, price: 25, image: "images/products/mint.webp" },
        { name: { en: "Ginger", ar: "زنجبيل", ru: "Имбирь", de: "Ingwer", it: "Zenzero" }, desc: { en: "Hot ginger drink", ar: "مشروب زنجبيل ساخن", ru: "Горячий имбирный напиток", de: "Heißes Ingwergetränk", it: "Bevanda calda allo zenzero" }, price: 30, image: "images/products/ginger.webp" },
        { name: { en: "Cinnamon", ar: "قرفة", ru: "Корица", de: "Zimt", it: "Cannella" }, desc: { en: "Hot cinnamon drink", ar: "مشروب قرفة ساخن", ru: "Горячий напиток с корицей", de: "Heißes Zimtgetränk", it: "Bevanda calda alla cannella" }, price: 30, image: "images/products/cinnamon.webp" },
        { name: { en: "Herbal Tea", ar: "شاي أعشاب", ru: "Травяной чай", de: "Kräutertee", it: "Tè alle erbe" }, desc: { en: "Mixed herbal tea", ar: "شاي أعشاب مشكل", ru: "Смешанный травяной чай", de: "Gemischter Kräutertee", it: "Tè alle erbe misto" }, price: 40, image: "images/products/herbal-tea.webp" }
      ]
    },
    {
      id: "iced-coffee",
    ...
    },
    {
      ...
      products: [
        { name: { en: "Sprite", ar: "سبرايت", ru: "Спрайт", de: "Sprite", it: "Sprite" }, desc: { en: "Lemon-lime soda", ar: "صودا ليمون-لايم", ru: "Газировка с лимоном и лаймом", de: "Zitronen-Limetten-Limonade", it: "Gassosa al limone e lime" }, price: 25, image: "images/products/sprite.webp" },
        { name: { en: "Seven Up", ar: "سيفن أب", ru: "Севен Ап", de: "Seven Up", it: "Seven Up" }, desc: { en: "Lemon-lime soda", ar: "صودا ليمون-لايم", ru: "Газировка с лимоном и лаймом", de: "Zitronen-Limetten-Limonade", it: "Gassosa al limone e lime" }, price: 25, image: "images/products/sevenup.webp" },
        { name: { en: "Pepsi", ar: "بيبسي", ru: "Пепси", de: "Pepsi", it: "Pepsi" }, desc: { en: "Pepsi cola", ar: "بيبسي كولا", ru: "Пепси кола", de: "Pepsi Cola", it: "Pepsi Cola" }, price: 25, image: "images/products/pepsi.webp" },
        { name: { en: "Fayrouz", ar: "فيروز", ru: "Файруз", de: "Fayrouz", it: "Fayrouz" }, desc: { en: "Fayrouz non-alcoholic malt drink", ar: "مشروب مالت غير كحولي فيروز", ru: "Безалкогольный солодовый напиток", de: "Fayrouz alkoholfreies Malzgetränk", it: "Bevanda al malto analcolica Fayrouz" }, price: 30, image: "images/products/fayrouz.webp" },
        { name: { en: "Diet Pepsi", ar: "بيبسي دايت", ru: "Пепси лайт", de: "Diet Pepsi", it: "Pepsi Diet" }, desc: { en: "Diet Pepsi cola", ar: "بيبسي دايت", ru: "Диетическая пепси", de: "Diät-Pepsi Cola", it: "Pepsi Cola dietetica" }, price: 25, image: "images/products/diet-pepsi.webp" },
        { name: { en: "Birell", ar: "بيريل", ru: "Бирелль", de: "Birell", it: "Birell" }, desc: { en: "Non-alcoholic beer", ar: "بيرة غير كحولية", ru: "Безалкогольное пиво", de: "Alkoholfreies Bier", it: "Birra analcolica" }, price: 30, image: "images/products/birell.webp" },
        { name: { en: "Coca-Cola", ar: "كوكاكولا", ru: "Кока-кола", de: "Coca-Cola", it: "Coca-Cola" }, desc: { en: "Coca-Cola", ar: "كوكاكولا", ru: "Кока-кола", de: "Coca-Cola", it: "Coca-Cola" }, price: 25, image: "images/products/cocacola.webp" },
        { name: { en: "Coca-Cola Zero", ar: "كوكاكولا زيرو", ru: "Кока-кола зеро", de: "Coca-Cola Zero", it: "Coca-Cola Zero" }, desc: { en: "Zero sugar Coca-Cola", ar: "كوكاكولا بدون سكر", ru: "Кока-кола без сахара", de: "Coca-Cola ohne Zucker", it: "Coca-Cola senza zucchero" }, price: 25, image: "images/products/cocacola-zero.webp" },
        { name: { en: "Soda", ar: "صودا", ru: "Содовая", de: "Soda", it: "Soda" }, desc: { en: "Plain soda water", ar: "ماء صودا عادي", ru: "Обычная газированная вода", de: "Einfaches Sodawasser", it: "Acqua di soda naturale" }, price: 30, image: "images/products/soda.webp" },
        { name: { en: "Tonic", ar: "تونيك", ru: "Тоник", de: "Tonic", it: "Tonico" }, desc: { en: "Tonic water", ar: "ماء تونيك", ru: "Тонизирующая вода", de: "Tonic Water", it: "Acqua tonica" }, price: 30, image: "images/products/tonic.webp" },
        { name: {en: "red bull", ar: "ريد بول", ru: "Ред Булл энергетический напиток", de: "Red Bull Energy Drink", it: "Red Bull Energy Drink"}, desc: {en: "Red Bull energy drink", ar: "ريد بول مشروب طاقة", ru: "Ред Булл энергетический напиток", de: "Red Bull Energy Drink", it: "Red Bull Energy Drink"}, price: 35, image: "images/products/redbull.webp" },
        { name: { en: "Small Bottled Water", ar: "ماء زجاجة صغيرة", ru: "Маленькая бутылка воды", de: "Kleine Flasche Wasser", it: "Acqua in Bottiglia Piccola" }, desc: { en: "Small water bottle", ar: "زجاجة ماء صغيرة", ru: "Маленькая бутылка воды", de: "Kleine Wasserflasche", it: "Bottiglietta d'acqua" }, price: 15, image: "images/products/water-small.webp" },
